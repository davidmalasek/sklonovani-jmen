...
def dativ(input_jmena):
    ...
    for jmeno in jmena:
        if jmeno[-1] == "y" or jmeno[-1] == "í" or jmeno[-1] == "é":
            ...
            if jmeno[-2] == "e":
                if (
                    jmeno[-3] == "c" or jmeno[-3] == "u" or jmeno[-3] == "i"
                ):  # Marcel, Samuel, Gabriel
            ...
            if jmeno[-2] == "k":  # Eliška
                ...
                jmeno[-2] == "ď" or jmeno[-2] == "l" and jmeno[-3] == "a"
            ):  # Láďa, Fiala
                output.append(jmeno[0:-1] + "ovi")
            elif (
                jmeno[-2] == "č" or jmeno[-2] == "j" or jmeno[-2] == "l"
            ):  # Ivča, Kája, Nikola
                output.append(jmeno[0:-1] + "e")
            elif (
                jmeno[-2] == "d"
