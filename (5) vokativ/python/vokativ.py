...
# Honza Skýpala 2022 (https://github.com/honzaskypala/osloveni)


def vokativ(input_jmena):
    output = []
    if " " in input_jmena:
    ...
    for jmeno in jmena:
        ...
        if c == "a":
            ...
            if c == "o":
                ...
                c = ljmeno[-3]
                if c == "r":
                    replacepair = ("", "e") if ljmeno[-4] == "a" else ("", "")
                elif c == "l":
            ...
            if c == "e":
                c = ljmeno[-3]
                if c == "i":
                    replacepair = ("", "") if ljmeno[-4] == "r" else ("", "i")
                elif c == "r":
            ...
            if c == "n":
                ...
                replacepair = (
                    ("", "i")
                    if c == "s" or c == "a" or c == "o" or c == "c" or c == "t"
                    else ("", "")
                )
        elif c == "t":
            c = ljmeno[-2]
            ...
            if c == "e":
                ...
                replacepair = (
                    ("r", "ře") if c == "d" or c == "t" or c == "b" else ("", "e")
                )
        elif c == "j":
            c = ljmeno[-2]
            if c == "o":
        ...
        if replacepair[0] == "" and replacepair[1] == "":
            ...
            output.append(jmeno[: -len(replacepair[0])])
        elif replacepair[0] == "":
            output.append(
                jmeno
                + (replacepair[1] if jmeno[-1].islower() else replacepair[1].upper())
            )
        else:
            replaceending = jmeno[-len(replacepair[0]) :]
            if replaceending.isupper():
                output.append(jmeno[: -len(replacepair[0])] + replacepair[1].upper())
            elif replaceending.istitle():
                output.append(jmeno[: -len(replacepair[0])] + replacepair[1].title())
            elif jmeno[-1].isupper():
                output.append(jmeno[: -len(replacepair[0])] + replacepair[1].upper())
            else:
                output.append(jmeno[: -len(replacepair[0])] + replacepair[1])
